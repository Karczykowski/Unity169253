...
public class RequireAndDisallowExample : MonoBehaviour
{
    void Start()
    {
        ...
        if (rb != null)
        {
            UnityEngine.Debug.Log("Rigidbody component is present as required.");
        }
        else
        {
            UnityEngine.Debug.LogError("Rigidbody component is missing, which should not happen due to [RequireComponent].");
        }
    }
}
