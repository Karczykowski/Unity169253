...
public class TestAttributes : MonoBehaviour
{
    ...
    void Start()
    {
        UnityEngine.Debug.Log("Serialized Private Value: " + serializedPrivateValue);
        UnityEngine.Debug.Log("Hidden Public Value: " + hiddenPublicValue);
        UnityEngine.Debug.Log("Ranged Value: " + rangedValue);
        UnityEngine.Debug.Log("Value With Tooltip: " + valueWithTooltip);
        UnityEngine.Debug.Log("Multiline Text: " + multilineText);
        UnityEngine.Debug.Log("Text Area: " + textArea);
    }
}
