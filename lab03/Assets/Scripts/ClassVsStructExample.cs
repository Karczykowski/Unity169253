...
public class ClassVsStructExample : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pointClassB.x = 2f;
        UnityEngine.Debug.Log("PointClass A: x = " + pointClassA.x + ", y = " + pointClassA.y); // Outputs: x = 2, y = 1
        UnityEngine.Debug.Log("PointClass B: x = " + pointClassB.x + ", y = " + pointClassB.y); // Outputs: x = 2, y = 1
        ...
        pointStructB.x = 2f;
        UnityEngine.Debug.Log("PointStruct A: x = " + pointStructA.x + ", y = " + pointStructA.y); // Outputs: x = 1, y = 1
        UnityEngine.Debug.Log("PointStruct B: x = " + pointStructB.x + ", y = " + pointStructB.y); // Outputs: x = 2, y = 1
    }
}
