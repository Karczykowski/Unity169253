...
public class ContextMenuExample : MonoBehaviour
{
    ...
    void ResetValues()
    {
        UnityEngine.Debug.Log("Values have been reset.");
    }
    ...
    void LogFieldValue()
    {
        UnityEngine.Debug.Log("Value With Context Menu Item: " + valueWithContextMenuItem);
    }
}
...
public class InitializeOnLoadExample
{
    ...
    {
        UnityEngine.Debug.Log("InitializeOnLoadExample has been initialized when Unity started.");
    }
}
