...
public class MathfMethodsDemo : MonoBehaviour
{
    void Start()
    {
        ...
        UnityEngine.Debug.Log("Absolute Value of -10: " + absoluteValue); // Outputs: 10
        ...
        UnityEngine.Debug.Log("Lerp between 0 and 100 at t=0.25: " + lerpValue); // Outputs: 25

        // Mathf.Sqrt: Returns the square root of a value
        float squareRootValue = Mathf.Sqrt(16f);
        UnityEngine.Debug.Log("Square Root of 16: " + squareRootValue); // Outputs: 4
        ...
        UnityEngine.Debug.Log("Sine of 30 degrees: " + sineValue); // Outputs: 0.5

        // Mathf.Pow: Returns a value raised to a power
        float baseValue = 2f;
        float powerValue = 3f;
        float result = Mathf.Pow(baseValue, powerValue);
        UnityEngine.Debug.Log("2 raised to the power of 3: " + result); // Outputs: 8
    }
}
